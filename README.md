...
You can safely require this library in Node and __absolutely nothing will happen__ :). A dummy object is exported so that requiring the library does not throw an error. Hls.js is not instantiable in Node.js.  See [#1841](https://github.com/video-dev/hls.js/pull/1841) for more details.
